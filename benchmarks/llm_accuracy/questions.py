...
def generate_questions() -> list[Question]:
    ...
    if tabular:
        ...
        departments = list(set(e["department"] for e in tabular))
    ...
    if nested:
        ...
        statuses = list(set(o["status"] for o in nested))
    ...
    if github:
        ...
        owners = list(set(r["owner"] for r in github))
