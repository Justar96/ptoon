...
**Advantage:** TOON achieves **100.0% accuracy** (vs JSON's 100.0%) while using **48.5% fewer tokens**.

| Format | Accuracy | Avg Tokens | Avg Latency (ms) | Input Tokens | Output Tokens | Est. Cost |
|--------|----------|------------|------------------|--------------|---------------|-----------|
| `JSON` | 100.0% | 11,076 | 3021.2 | 60,333 | 117 | $0.0091 |
| `TOON` | 100.0% | 5,703 | 4033.0 | 22,053 | 245 | $0.0035 |

*Costs based on OpenAI pricing: $0.15 per 1M input tokens, $0.60 per 1M output tokens (cached: $0.015/1M). Estimates use regular pricing; actual costs may be ~40-60% lower with prompt caching.*
